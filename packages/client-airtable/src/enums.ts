 ...
 *
 * The {@link Timezone} and {@link UserLocale} parameters are required when using `string` as the cell  format.
 *
...
export enum CellFormat {
    ...
    /** Cells will be formatted as user-facing strings, regardless of the field type. */
    STRING = 'string',
}
...
/**
 * The time zone that should be used to format dates when using `string` as the {@link CellFormat}.
 */
...
export enum UpdateType {
    /** Will update the included fields and clear all unincluded fields. */
    FULL = 'PUT',

    /** Will only update the included fields. Fields not included will be unchanged. */
    PARTIAL = 'PATCH',
}

/**
 * The user locale that should be used to format dates when using `string` as the {@link CellFormat}.
 */
